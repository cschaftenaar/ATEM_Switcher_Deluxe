    ...
    public partial class Form1 : Form
    {
        ...
        {  
            ...
            else
            {
                ...
                lblUID.Text = "Unit ID: " + xk24_1.GetDeviceUID(0);

                //Gets the OEM Version ID from the device
                lblOEM.Text = "OEM ID: " + xk24_1.GetOEMVersionID(0);

                //Gets the Product ID from the device
                lblProductID.Text = "Product ID: " + xk24_1.GetProductID(0);
            }
        }
        ...
        private void btnGreenLED_Click(object sender, EventArgs e)
        {
            ...
            if (xk24_1.GetGreenIndicatorLED(0) == false)
            {
        ...
        private void btnRedLED_Click(object sender, EventArgs e)
        {
            ...
            if (xk24_1.GetRedIndicatorLED(0) == false)
            {
        ...
        private void btnToggleBlue_Click(object sender, EventArgs e)
        {
            //Toggles blue bank
            if (AllBlue == true)
            {
        ...
        private void HandlePlug(Xk24.XKeyPlugEventArgs e)
        {
