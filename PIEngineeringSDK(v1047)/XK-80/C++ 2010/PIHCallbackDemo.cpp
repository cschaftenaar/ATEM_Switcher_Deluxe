	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1089)
				{
					AddEventMsg(hDialog, "Found Device: XK-80, PID=1089 (PID #1)");
				}
				else if (pid==1090)
				{
					AddEventMsg(hDialog, "Found Device: XK-80, PID=1090 (PID #2)");
				}
				else if (pid==1091)
				{
					AddEventMsg(hDialog, "Found Device: XK-80, PID=1091 (PID #3)");
				}
				else if (pid==1250)
				{
					AddEventMsg(hDialog, "Found Device: XK-80, PID=1250 (PID #4)");
				}
				else if (pid==1121)
				{
					AddEventMsg(hDialog, "Found Device: XK-60, PID=1121 (PID #1)");
				}
				else if (pid==1122)
				{
					AddEventMsg(hDialog, "Found Device: XK-60, PID=1122 (PID #2)");
				}
				else if (pid==1123)
				{
					AddEventMsg(hDialog, "Found Device: XK-60, PID=1123 (PID #3)");
				}
				else if (pid==1254)
				{
					AddEventMsg(hDialog, "Found Device: XK-60, PID=1254 (PID #4)");
				}
				else
				{
