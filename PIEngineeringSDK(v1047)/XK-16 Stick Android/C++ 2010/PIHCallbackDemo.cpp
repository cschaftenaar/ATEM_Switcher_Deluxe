	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1213)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick Android, PID=1213 (PID #1)");
				}
				else if (pid==1214)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick Android, PID=1214 (PID #2)");
				}
				else if (pid==1215)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick Android, PID=1215 (PID #3)");
				}
				else if (pid==1216)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick Android, PID=1216 (PID #4)");
				}
				else
				{
