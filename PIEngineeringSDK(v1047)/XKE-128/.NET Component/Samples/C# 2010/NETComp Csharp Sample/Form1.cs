    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblUID.Text = "Unit ID: " + xk128_1.GetDeviceUID(0);

                //Gets the OEM Version ID from the device
                lblOEM.Text = "OEM ID: " + xk128_1.GetOEMVersionID(0);

                //Gets the Product ID from the device
                lblProductID.Text = "Product ID: " + xk128_1.GetProductID(0);
            }
        }
        ...
        private void btnGreenLED_Click(object sender, EventArgs e)
        {
            ...
            if (xk128_1.GetGreenIndicatorLED(0) == false)
            {
        ...
        private void btnRedLED_Click(object sender, EventArgs e)
        {
            ...
            if (xk128_1.GetRedIndicatorLED(0) == false)
            {
        ...
        private void btnUID_Click(object sender, EventArgs e)
        {
            ...
            lblUID.Text = "Unit ID: " + xk128_1.GetDeviceUID(0).ToString();
        }
