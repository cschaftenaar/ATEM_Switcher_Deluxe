	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1227)
				{
					AddEventMsg(hDialog, "Found Device: XK-128, PID=1227 (PID #1)");
				}
				else if (pid==1228)
				{
					AddEventMsg(hDialog, "Found Device: XK-128, PID=1228 (PID #2)");
				}
				else if (pid==1229)
				{
					AddEventMsg(hDialog, "Found Device: XK-128, PID=1229 (PID #3)");
				}
				else if (pid==1230)
				{
					AddEventMsg(hDialog, "Found Device: XK-128, PID=1230 (PID #4)");
				}
				else
				{
