	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1192)
				{
					AddEventMsg(hDialog, "Found Device: XK-12 Switch Interface, PID=1192 (PID #1)");
				}
				else if (pid==1193)
				{
					AddEventMsg(hDialog, "Found Device: XK-12 Switch Interface, PID=1193 (PID #2)");
				}
				else if (pid==1194)
				{
					AddEventMsg(hDialog, "Found Device: XK-12 Switch Interface, PID=1194 (PID #3)");
				}
				else if (pid==1195)
				{
					AddEventMsg(hDialog, "Found Device: XK-12 Switch Interface, PID=1195 (PID #4)");
				}
				else if (pid==1221)
				{
					AddEventMsg(hDialog, "Found Device: XK-3 Switch Interface, PID=1221 (PID #1)");
				}
				else if (pid==1222)
				{
					AddEventMsg(hDialog, "Found Device: XK-3 Switch Interface, PID=1222 (PID #2)");
				}
				else if (pid==1223)
				{
					AddEventMsg(hDialog, "Found Device: XK-3 Switch Interface, PID=1223 (PID #3)");
				}
				else if (pid==1224)
				{
					AddEventMsg(hDialog, "Found Device: XK-3 Switch Interface, PID=1224 (PID #4)");
				}
				else
				{
