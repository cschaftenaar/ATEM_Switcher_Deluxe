	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1244)
				{
					AddEventMsg(hDialog, "Found Device: IAB-HD15-Wire Interface, PID=1244 (PID #1)");
				}
				else if (pid==1245)
				{
					AddEventMsg(hDialog, "Found Device: IAB-HD15-Wire Interface, PID=1245 (PID #2)");
				}
				else if (pid==1246)
				{
					AddEventMsg(hDialog, "Found Device: IAB-HD15-Wire Interface, PID=1246 (PID #3)");
				}
				else if (pid==1247)
				{
					AddEventMsg(hDialog, "Found Device: IAB-HD15-Wire Interface, PID=1247 (PID #4)");
				}
				else if (pid==1169)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-8, PID=1169 (PID #1)");
				}
				else if (pid==1170)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-8, PID=1170 (PID #2)");
				}
				else if (pid==1171)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-8, PID=1171 (PID #3)");
				}
				else if (pid==1172)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-8, PID=1172 (PID #4)");
				}
				else if (pid==1145)
				{
					AddEventMsg(hDialog, "Found Device: X-keys IABSTG-10, PID=1145 (PID #1)");
				}
				else if (pid==1146)
				{
					AddEventMsg(hDialog, "Found Device: X-keys IABSTG-10, PID=1146 (PID #2)");
				}
				else if (pid==1147)
				{
					AddEventMsg(hDialog, "Found Device: X-keys IABSTG-10, PID=1147 (PID #3)");
				}
				else if (pid==1148)
				{
					AddEventMsg(hDialog, "Found Device: X-keys IABSTG-10, PID=1148 (PID #4)");
				}
				else if (pid==1153)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-6, PID=1153 (PID #1)");
				}
				else if (pid==1154)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-6, PID=1154 (PID #2)");
				}
				else if (pid==1155)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-6, PID=1155 (PID #3)");
				}
				else if (pid==1156)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-6, PID=1156 (PID #4)");
				}
				else if (pid==1157)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-4, PID=1157 (PID #1)");
				}
				else if (pid==1158)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-4, PID=1158 (PID #2)");
				}
				else if (pid==1159)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-4, PID=1159 (PID #3)");
				}
				else if (pid==1160)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-4, PID=1160 (PID #4)");
				}
				else if (pid==1161)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-2, PID=1161 (PID #1)");
				}
				else if (pid==1162)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-2, PID=1162 (PID #2)");
				}
				else if (pid==1163)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-2, PID=1163 (PID #3)");
				}
				else if (pid==1164)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XKIP-2, PID=1164 (PID #4)");
				}
				else
				{
