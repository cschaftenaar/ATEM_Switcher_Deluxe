            ...
            else
            {
                ...
                for (int i = 0; i < devices.Length; i++)
                {
                    ...
                    if (devices[i].HidUsagePage == 0xc)// && devices[i].WriteLength==36)
                    {
                        ...
                        {
                            case 1244:
                                CboDevices.Items.Add("IAB-HD15-Wire Interface(" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1245:
                                CboDevices.Items.Add("IAB-HD15-Wire Interface(" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1246:
                                CboDevices.Items.Add("IAB-HD15-Wire Interface(" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1247:
                                CboDevices.Items.Add("IAB-HD15-Wire Interface(" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1169:
                            ...
                            case 1172:
                                ...
                                break;
                            case 1145:
                                CboDevices.Items.Add("IAB-STG-10 (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1146:
                                CboDevices.Items.Add("IAB-STG-10 (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1147:
                                CboDevices.Items.Add("IAB-STG-10 (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1148:
                                CboDevices.Items.Add("IAB-STG-10 (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1153:
                            ...
                            case 1164:
                                ...
                                break;
                            case 1184:
                                CboDevices.Items.Add("IAB-PT5-10 (" + devices[i].Pid + "=PID #1)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1185:
                                CboDevices.Items.Add("IAB-PT5-10 (" + devices[i].Pid + "=PID #2)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1186:
                                CboDevices.Items.Add("IAB-PT5-10 (" + devices[i].Pid + "=PID #3)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
                            case 1187:
                                CboDevices.Items.Add("IAB-PT5-10 (" + devices[i].Pid + "=PID #4)");
                                cbotodevice[cbocount] = i;
                                cbocount++;
                                break;
