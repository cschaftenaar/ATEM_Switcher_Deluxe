	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1114)
				{
					AddEventMsg(hDialog, "Found Device: XK-68 Jog & Shuttle, PID=1114 or PID #1");
				}
				else if (pid==1115)
				{
					AddEventMsg(hDialog, "Found Device: XK-68 Jog & Shuttle, PID=1115");
				}
				else if (pid==1116)
				{
					AddEventMsg(hDialog, "Found Device: XK-68 Jog & Shuttle, PID=1116 or PID #2");
				}
				else
				{
