	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1049)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick, PID=1049 (PID #1)");
				}
				else if (pid==1050)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick, PID=1050 (PID #2)");
				}
				else if (pid==1051)
				{
					AddEventMsg(hDialog, "Found Device: XK-16 Stick, PID=1051 (PID #3)");
				}
				else if (pid==1251)
				{
					AddEventMsg(hDialog, "Found Device: XK-4 Stick, PID=1251 (PID #4)");
				}
				else if (pid==1127)
				{
					AddEventMsg(hDialog, "Found Device: XK-4 Stick, PID=1127 (PID #1)");
				}
				else if (pid==1128)
				{
					AddEventMsg(hDialog, "Found Device: XK-4 Stick, PID=1128 (PID #2)");
				}
				else if (pid==1129)
				{
					AddEventMsg(hDialog, "Found Device: XK-4 Stick, PID=1129 (PID #3)");
				}
				else if (pid==1253)
				{
					AddEventMsg(hDialog, "Found Device: XK-4 Stick, PID=1253 (PID #4)");
				}
				else if (pid==1130)
				{
					AddEventMsg(hDialog, "Found Device: XK-8 Stick, PID=1127 (PID #1)");
				}
				else if (pid==1131)
				{
					AddEventMsg(hDialog, "Found Device: XK-8 Stick, PID=1128 (PID #2)");
				}
				else if (pid==1132)
				{
					AddEventMsg(hDialog, "Found Device: XK-8 Stick, PID=1129 (PID #3)");
				}
				else if (pid==1252)
				{
					AddEventMsg(hDialog, "Found Device: XK-8 Stick, PID=1253 (PID #4)");
				}
				else
				{
