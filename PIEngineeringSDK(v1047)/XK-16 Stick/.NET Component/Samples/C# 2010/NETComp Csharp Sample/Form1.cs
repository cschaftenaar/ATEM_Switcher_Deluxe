    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblUID.Text = "Unit ID: " + xk16_8_4_1.GetDeviceUID(0);

                //Gets the OEM Version ID from the device
                lblOEM.Text = "OEM ID: " + xk16_8_4_1.GetOEMVersionID(0);

                //Gets the Product ID from the device
                lblProductID.Text = "Product ID: " + xk16_8_4_1.GetProductID(0);
            }
        }
        ...
        private void btnGreenLED_Click(object sender, EventArgs e)
        {
            ...
            if (xk16_8_4_1.GetGreenIndicatorLED(0) == false)
            {
        ...
        private void btnRedLED_Click(object sender, EventArgs e)
        {
            ...
            if (xk16_8_4_1.GetRedIndicatorLED(0) == false)
            {
        ...
        private void btnUID_Click(object sender, EventArgs e)
        {
            ...
            lblUID.Text = "Unit ID: " + xk16_8_4_1.GetDeviceUID(0).ToString();
        }
        ...
        private void btnOEM_Click(object sender, EventArgs e)
        {
            ...
            xk16_8_4_1.SetOEMVersionID(0, id);
