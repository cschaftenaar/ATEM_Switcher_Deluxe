...
Public Class Form1
            ...
            For i As Integer = 0 To devices.Length - 1
                If devices(i).HidUsagePage = 12 Then
                    Select Case devices(i).Pid
                        Case 1269
                            ...
                            CboDevices.Items.Add("XK-16 KVM (" + devices(i).Pid.ToString + "=PID #1)")
                ...
                Else
                    If (devices(i).Pid = 1270) Then
                        ...
                        CboDevices.Items.Add("XK-16 KVM (" + devices(i).Pid.ToString + "=PID #2 - no reading or writing available, change to PID #1 by sliding program switch up and replugging device.)")
                        cbotodevice(cbocount) = i
                        cbocount = cbocount + 1
                        DisableAllControls()
                    End If
    ...
    Private Sub ChkFlash_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkFlash.CheckedChanged
        ...
        If selecteddevice <> -1 Then
            ...
            Dim sindex As String = CboKeyIndex.Text
            Dim iindex As Integer
            If (sindex.IndexOf("g") <> -1) Then  'bank 1
    ...
    Private Sub DisableAllControls()
        For Each cl As Control In Controls
            ...
            End If
        Next
        MessageBox.Show("Device in PID #2 (KVM), no input or output reports are available.  To change to PID #1 press and hold the program switch while plugging the device into usb port.")
    End Sub
