	...
	for (long i=0; i<count; i++)    {
		...
		{	
			...
			else    
			{
				...
				if (pid==1030)
				{
					AddEventMsg(hDialog, "Found Device: X-keys Matrix Encoder Board, PID=1030 (PID #1)");
				}
				else if (pid==1031)
				{
					AddEventMsg(hDialog, "Found Device: X-keys Matrix Encoder Board, PID=1031 (PID #2)");
				}
				else if (pid==1032)
				{
					AddEventMsg(hDialog, "Found Device: X-keys Matrix Encoder Board, PID=1032 (PID #3)");
				}
				else if (pid==1255)
				{
					AddEventMsg(hDialog, "Found Device: X-keys Matrix Encoder Board, PID=1255 (PID #4)");
				}
				else if (pid==1080)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1080(PID #1)");
				}
				else if (pid==1081)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1081 (PID #2)");
				}
				else if (pid==1082)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1082 (PID #3)");
				}
				else if (pid==1256)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1256 (PID #4)");
				}
				else if (pid==1068)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1068(PID #1)");
				}
				else if (pid==1069)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1069 (PID #2)");
				}
				else if (pid==1070)
				{
					AddEventMsg(hDialog, "Found Device: X-keys XK-3 Foot Pedal, PID=1070 (PID #3)");
				}
				else
				{
